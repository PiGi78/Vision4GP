...
namespace Vision4GP.Core.Microfocus
{
    ...
    internal partial class MicrofocusVisionLibrary
    {
        ...
        /// <summary>
        /// Microfocus vision library for Linux
        /// </summary>
        private class LinuxVisionLibrary : IMicrofocusVisionLibrary
        {


            #region Microfocus Linux library call


            private const string MICROFOCUST_DLL = "libvision64.so";


            [DllImport(MICROFOCUST_DLL, EntryPoint = "v6_init")]
            private static extern int MicrofocusV6Init();

            [DllImport(MICROFOCUST_DLL, EntryPoint = "ACLoadFile")]
            private static extern int MicrofocusACLoadFile(string filePath, int unused0, int unused1, int unused2);

            [DllImport(MICROFOCUST_DLL, EntryPoint = "SetLArgv0")]
            private static extern void MicrofocusSetLArgv0(string licenseFileName);

            [DllImport(MICROFOCUST_DLL, EntryPoint = "v6_exit")]
            private static extern void MicrofocusV6Exit();

            [DllImport(MICROFOCUST_DLL, EntryPoint = "v6_make")]
